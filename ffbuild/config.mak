...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libmp3lame --enable-openssl --enable-gpl --enable-nonfree
prefix=/usr/local
...
CC_IDENT=gcc 4.4.7 (GCC) 20120313 (Red Hat 4.4.7-18)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
